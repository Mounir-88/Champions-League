...
<body>
    ...
    <div class="container">
        ...
        // SQL query to retrieve matches where the referee has a nationality different from both of the competing teams
        $sql = "SELECT m.*, r.referee_name, r.nationality AS RefereeNationality, t1.name AS HomeTeam, t2.name AS AwayTeam
                FROM Matches m
        ...
        if ($result->num_rows > 0) {
            ...
            echo '<tr><th>Match ID</th><th>Date</th><th>Home Team</th><th>Away Team</th><th>Home Team Score</th><th>Away Team Score</th><th>Winner</th><th>Spectators</th><th>Referee</th></tr>';
