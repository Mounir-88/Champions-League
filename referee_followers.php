...
<body>
    ...
    <div class="container">
        ...
        // SQL query to retrieve matches where the referee's social media followers are more than 100,000
        $sql = "SELECT m.*, r.referee_name, s.followers
                FROM Matches m
        ...
        if ($result->num_rows > 0) {
            ...
            echo '<tr><th>Match ID</th><th>Date</th><th>Home Team</th><th>Away Team</th><th>Home Team Score</th><th>Away Team Score</th><th>Winner</th><th>Spectators</th><th>Referee</th><th>Stadium</th><th>Referee Followers</th></tr>';
