...
<body>
    ...
    <div class="container">
        ...
        // SQL query to retrieve matches where the away team won and the referee is from German nationality
        $sql = "SELECT * FROM Matches, Referee Where Matches.referee_id = Referee.referee_id AND Referee.nationality = 'German'";
        $result = $conn->query($sql);

        if ($result->num_rows > 0) {
            // Output data of each row
            echo '<table class="matches-table">';
            echo '<tr><th>Match ID</th><th>Date</th><th>Home Team</th><th>Away Team</th><th>Home Team Score</th><th>Away Team Score</th><th>Winner</th><th>Spectators</th><th>Referee</th><th>Stadium</th></tr>';
